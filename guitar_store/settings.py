...
DATABASES = {
    'default': dj_database_url.parse('postgres://duxuatll:plAy8Q3nMYLQPfAQxDFfhbGkNfFEMvx_@trumpet.db.elephantsql.com/duxuatll')
}
...
DEFAULT_FROM_EMAIL = 'guitarstore@exemple.com'
